...
abstract class AbstractItem extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('RKTeamModule detail view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display or link a single RKTeamModule object.');
    }
    ...
    public function display()
    {
        ...
        $controllerReference = new ControllerReference('RKTeamModule:External:display', $this->getDisplayArguments());
