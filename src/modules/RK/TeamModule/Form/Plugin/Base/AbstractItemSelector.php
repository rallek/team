...
namespace RK\TeamModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@RKTeamModule:js/RKTeamModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@RKTeamModule:js/RKTeamModule.Finder.js'));
        ...
        if (!$permissionApi->hasPermission('RKTeamModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('RKTeamModule_objecttype', 'person');
