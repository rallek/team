...
abstract class AbstractAjaxController extends AbstractController
{
    ...
    {
        if (!$this->hasPermission('RKTeamModule::Ajax', '::', ACCESS_EDIT)) {
            return true;
        }
        ...
        $view = \Zikula_View::getInstance('RKTeamModule', false);
    ...
    public function getItemListFinderAction(Request $request)
    {
        ...
        $objectType = $request->request->getAlnum('ot', 'person');
    ...
    protected function prepareSlimItem($repository, $objectType, $item, $itemId, $descriptionField)
    {
        ...
        $previewInfo = base64_encode($this->get('twig')->render('@RKTeamModule/External/' . ucfirst($objectType) . '/info.html.twig', $previewParameters));
