...
namespace RK\TeamModule\Twig\Base;
...
use RK\TeamModule\Helper\WorkflowHelper;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('rkteammodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('rkteammodule_templateSelector', [$this, 'getTemplateSelector']),
            new \Twig_SimpleFunction('rkteammodule_userAvatar', [$this, 'getUserAvatar'], ['is_safe' => ['html']])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('rkteammodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('rkteammodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('rkteammodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The rkteammodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|rkteammodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|rkteammodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The rkteammodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|rkteammodule_fileSize }}
     *
    ...
    /**
     * The rkteammodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|rkteammodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The rkteammodule_objectTypeSelector function provides items for a dropdown selector.
     *
    ...
    /**
     * The rkteammodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    public function getUserAvatar($uid = 0, $width = 0, $height = 0, $size = 0, $rating = '')
    {
        ...
        $view = \Zikula_View::getInstance('RKTeamModule');
