...
namespace RK\TeamModule\Block\Base;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('RKTeamModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('RKTeamModule items');
        }
    ...
    {
        return 'RK\TeamModule\Block\Form\Type\ItemListBlockType';
    }
    ...
    {
        return '@RKTeamModule/Block/itemlist_modify.html.twig';
    }
