...
abstract class AbstractUserListener implements EventSubscriberInterface
{
    ...
    public function delete(GenericEvent $event)
    {
        ...
        // set last editor to guest (1) for all persons affected by this user
        $repo->updateUserField('registeredUser', $userId, 1, $this->translator, $this->logger, $this->currentUserApi);
        
        $logArgs = ['app' => 'RKTeamModule', 'user' => $this->currentUserApi->get('uname'), 'entities' => 'persons'];
