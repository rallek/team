...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('RKTeamModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('RKTeamModule_ContentType_ItemList');
    }
     ...
     * RKTeamModule will use this to add a javascript helper to add custom items.
     *
     * @param \Zikula_Event $event The event instance
     */
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                'module' => 'RKTeamModule',
                'type'   => 'javascript',
                'path'   => 'modules/RK/TeamModule/Resources/public/js/RKTeamModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkteammodule',
                'path' => 'modules/RK/TeamModule/Resources/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/rkteammodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkteammodule',
                'path' => 'modules/RK/TeamModule/Resources/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/rkteammodule/',
                'file' => 'plugin.js',
                'img'  => 'ed_rkteammodule.gif'
            ]
        );
    }
}
