...
use RK\TeamModule\Listener\Base\AbstractKernelListener;
...
class KernelListener extends AbstractKernelListener
{
    ...
    public function onRequest(GetResponseEvent $event)
    {
        ...
        // $event->getRequest()->attributes->set('RKTeamModule_test', $testMessage);
    ...
    public function onResponse(FilterResponseEvent $event)
    {
        ...
        // $testMessage = $event->getRequest()->attributes->get('RKTeamModule_test');
