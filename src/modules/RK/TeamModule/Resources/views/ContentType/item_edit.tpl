...
<div style="margin-left: 80px">
    <div class="form-group">
        {formlabel for='rKTeamModuleObjectType' __text='Object type' cssClass='col-sm-3 control-label'}
        <div class="col-sm-9">
    ...
    <div{* class="form-group"*}>
        ...
        {rkteammoduleItemSelector id='id' group='data' objectType=$objectType}
    </div>
