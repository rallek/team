...
function rKTeamReadDate(val, includeTime)
{
...
function rKTeamValidateNoSpace(val)
{
    var valStr;
...
function rKTeamValidateUploadExtension(val, elem)
{
 ...
 */
function rKTeamExecuteCustomValidationConstraints(objectType, currentEntityId)
{
    jQuery('.validate-nospace').each( function() {
        if (!rKTeamValidateNoSpace(jQuery(this).val())) {
    ...
    jQuery('.validate-upload').each( function() {
        if (!rKTeamValidateUploadExtension(jQuery(this).val(), jQuery(this))) {
